...
export function AuditLogsPage({ auditLogs, reportsData, onRefresh, hasPermission, bookings, rooms, activeBans }: AuditLogsPageProps) {
  ...
  // Format JSON values to a beautiful human-readable layout, optionally diffed with another state
  ...
  const formatValueFriendly = (key: string, val: any): string => {
  ...
  const formatObjectCompact = (obj: any, peer: any): string => {
    if (!obj) return '-';
  ...
  const renderAuditValue = (valueStr: string | null | undefined, peerStr?: string | null | undefined) => {
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-rose-50/20 p-4 rounded-xl border border-rose-100/20 flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-lg font-black font-mono text-rose-600">{rejectedBookingsCount}</p>
                    </div>
                  ...
                  <div className="bg-gray-50/50 p-4 rounded-xl border border-gray-100 flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-lg font-black font-mono text-gray-655 font-bold">{cancelledBookingsCount}</p>
                    </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
                ...
                <div className="lg:col-span-3 space-y-6">
                    ...
                    return (
                      <div className="space-y-6 animate-fade-in">
                        ...
                        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-3xs flex justify-between items-center">
                          ...
                          <button
                            onClick={() => exportTrendsPDF(purposeArray)}
                          ...
                          <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-3xs space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-center pt-2">
                              ...
                              <div className="bg-gray-50/40 border border-gray-150 p-3 rounded-xl">
                                ...
                                <span className="text-lg font-black font-mono text-gray-700 mt-1 block">{cancelledOutcome}</span>
                              ...
                              {topRequesters.length === 0 ? (
                                ...
                                topRequesters.map((user, idx) => (
                                  <div key={idx} className="flex justify-between items-center border-b border-gray-50 pb-2">
                                    ...
                                    <span className="font-black bg-indigo-50 border border-indigo-100 text-indigo-700 px-2 py-1 rounded-lg text-[10.5px] font-mono">{user.count} bookings</span>
                                  </div>
                                ))
                              )}
                            </div>
                  ...
                  {selectedReport === 'bookings' && (() => {
                    ...
                    const bookingTypes = ['Meeting', 'Student Society', 'Cohort Startup', 'Department', 'Event'];
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-5 gap-3.5 pt-1 text-xs">
                            <div className="space-y-1">
                              ...
                              <input 
                                ...
                                className="w-full px-2.5 py-1.5 border border-gray-150 rounded-lg text-xs bg-gray-50/50"
                              />
                            </div>
                            ...
                            <div className="space-y-1">
                              ...
                              <select
                                ...
                                className="w-full px-2 py-1.5 border border-gray-150 rounded-lg text-xs bg-gray-50/50 font-medium"
                              >
                            ...
                            <div className="space-y-1">
                              ...
                              <select
                                ...
                                className="w-full px-2 py-1.5 border border-gray-150 rounded-lg text-xs bg-gray-50/50 font-medium animate-fade-in"
                              >
                            ...
                            <div className="space-y-1">
                              ...
                              <input 
                                ...
                                className="w-full px-2 py-1.5 border border-gray-150 rounded-lg text-xs bg-gray-50/50 font-mono"
                              />
                            </div>
                            ...
                            <div className="space-y-1">
                              ...
                              <div className="flex gap-1">
                                ...
                                <button
                                  ...
                                  className="px-2.5 border border-gray-150 hover:bg-gray-50 bg-gray-50/50 rounded-lg text-gray-500 font-bold"
                                ...
                                {paginatedUtil.length === 0 ? (
                                  ...
                                  paginatedUtil.map(u => (
                                    <tr key={u.roomName} className="hover:bg-gray-50/50 transition-colors">
                                      ...
                                      <td className="py-4 px-5 font-mono font-bold text-gray-650">{u.capacity} guests limit</td>
                                      ...
                                      <td className="py-4 px-5 font-bold font-mono text-gray-800">{Math.round((u.utilizationMinutes / 60) * 10) / 10} hrs</td>
                            ...
                            <tbody className="divide-y divide-gray-100 text-gray-700">
                              {sortedPeak.map(p => (
                                <tr key={p.hour24} className="hover:bg-gray-50/50 transition-colors">
                                  ...
                                  <td className="py-4 px-5 font-bold font-mono text-gray-650">{p.totalCount} bookings</td>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 text-xs pt-1">
                            ...
                            <div className="space-y-1">
                              ...
                              <button
                                ...
                                className="w-full px-3 py-1.5 border border-gray-150 hover:bg-gray-50 bg-gray-50/50 rounded-lg text-gray-600 font-bold flex items-center justify-center gap-1.5 uppercase tracking-wider text-[10px]"
                              >
                                ...
                                {paginatedBans.length === 0 ? (
                                  ...
                                  paginatedBans.map(ban => (
                                    <tr key={ban.id} className="hover:bg-gray-50/50 transition-colors text-xs">
                                      ...
                                      <td className="py-4 px-5 font-semibold text-gray-850 font-mono text-[10.5px]">{ban.bannedBy}</td>
                                      <td className="py-4 px-5">
                                        <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider ${
                                      ...
                                      <td className="py-4 px-5 text-right font-medium max-w-xs break-words">
                                        {ban.status === 'Lifted' ? (
                                          <div>
                                            ...
                                            <p className="text-[9.5px] text-gray-400 italic">" {ban.liftedReason} "</p>
                                          </div>
                                        ) : (
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-3xs space-y-4">
                        ...
                        <div className="relative">
                          <input 
                            ...
                            value={searchQuery}
                            onChange={e => setSearchQuery(e.target.value)}
                            className="w-full pl-9 pr-3.5 py-2 border border-gray-150 rounded-xl text-xs bg-gray-50/40 focus:bg-white focus:ring-1 focus:ring-primary font-medium"
                          />
                          <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400">
                            <Search className="h-4 w-4" />
                          </span>
